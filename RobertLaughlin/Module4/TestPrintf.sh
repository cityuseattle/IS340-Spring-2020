...
printf "%b\n" "%b tells printf to print escape sequences. Two tabs after me\t\t."
printf "%s%d\n%s%f\n%s%e\n" "%d prints integers such as: " 25 "%f prints float numbers such as " 25.5 "%e prints with the exponential notation such as: " 25.5
